...
const PaymentCustomer = () => {
  ...
  return (
    <div>
        ...
        <div>
          <ul className='mx-10'>
            <Link ><li className='text-md bg-white rounded-xl p-3 mb-1 px-5 items-center flex justify-between'><p>Debit or Credit Card</p> <i className='text-4xl'><GrCreditCard/></i></li></Link>
